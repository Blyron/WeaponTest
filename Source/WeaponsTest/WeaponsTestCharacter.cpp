...
#include "WeaponsTestCharacter.h"
...
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Looking/Aiming
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AWeaponsTestCharacter::LookInput);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AWeaponsTestCharacter::LookInput);
	}
	else
	{
...
void AWeaponsTestCharacter::MoveInput(const FInputActionValue& Value)
{
...
void AWeaponsTestCharacter::LookInput(const FInputActionValue& Value)
{
...
void AWeaponsTestCharacter::DoAim(float Yaw, float Pitch)
{
	if (GetController())
	{
...
void AWeaponsTestCharacter::DoMove(float Right, float Forward)
{
	if (GetController())
	{
...
void AWeaponsTestCharacter::DoJumpStart()
{
	// pass Jump to the character
	Jump();
}

void AWeaponsTestCharacter::DoJumpEnd()
{
